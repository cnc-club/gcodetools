...
#					poly.draw(color = "Violet",width=4)					
	...
	def __init__(self):
		...
		self.OptionParser.add_option("",   "--area-inkscape-radius",		action="store", type="float", 		dest="area_inkscape_radius", default="0",			help="Area curves overlaping (depends on tool diameter [0,1])")
