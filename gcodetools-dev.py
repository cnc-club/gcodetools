...
def csp_offset(csp, r) :
	...
	def csp_join_offsets(prev,next,sp1,sp2,sp1_l,sp2_l,r):
		...
		if arc == [] :
			...
			# Clip prev by arc
			if csp_subpaths_start_to_end_distance2(prev,arc)>0.00001 :
			...
			if next == [] :
				return prev,[],arc
			if csp_subpaths_start_to_end_distance2(arc,next)>0.00001 :
